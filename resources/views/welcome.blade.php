@extends('layouts.header')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content">
                            ...
                            <h2>Empowered to dispense goodness</h2>
                            <p>Building and deploying innovative software products that impacts people positively and optimize enterprise value.</p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="popup-area">
                            <div class="container">
                                ...
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/F2HJF7FVIzA?si=GhGLJT-TSy4ITcg_" 
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="experince-img">
                            <img class="experience-img" src="assets/images/wujuuix.png" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="business-experience">
                            <div class="section-heading">
                               ...
                               <!-- <p>WujuPay is a financial platform that transforms how underserved individuals and communities access financial resources. WujuPay adopts a 
                                    ...
                                    <p>At the heart of Owujupe is WujuPay, a fintech solution designed for underserved and underbanked communities, newcomers, 
                                        and everyday people who need access to bulk funds for education, business, 
                                        debt repayment, or life milestones. Through a rotational savings model, 
                                        members contribute agreed amounts into a shared pool, taking turns to access 
                                        the funds until every member benefits. This community-driven approach not only 
                                        democratizes access to finance but also fosters trust, collaboration, and shared 
                                        responsibility.</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                        <div class="business-experience">
                            <div class="section-heading">
                                <span class="subtitle">UPCOMING:</span>
                                 <h2>WujuChain</h2>
                              
                                    <p>WujuChain is Owujupe’s blockchain-powered platform that automates rotational savings, community fund pooling, and trustless financial collaboration using smart contracts.
                                    WujuChain ensures every transaction is transparent, tamper-proof, and trustless — giving users confidence while enabling innovation across savings, payments, and digital assets (stable coins).</p>
                                
                            </div>
                            <a class="default-btn" target="_blank" href="https://onchain.wujupay.ca">LEARN MORE</a>
                     ...
                     <div class="col-lg-5">
                        <div class="experince-img">
                            <img class="experience-img" src="assets/images/wujuchain_.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="marketing-area ptb-100 bg-color-f9f9f9">
            <div class="container" id="about">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="marketing-content">
                            <div class="section-heading">
                                ...
                                <h2>Owujupe Inc</h2>
                                <p>Owujupé is a dynamic technology-driven organization dedicated to empowering businesses, individuals, and communities through innovative tech solutions, financial empowerment tools, and community development programs. We are more than just a service provider;
                    ...
                    <div class="col-lg-5">
                        <div class="">
                            <img class="" src="assets/images/owujupeGraphics.png" alt="success-img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="best-service-area pt-100 pb-70">
            <div class="container" id="services">
                ...
                <div class="awesome-slider owl-carousel owl-theme owl-loaded owl-drag">
                    <div class="awesome-card" src="#" data-cue="fadeIn">
                        ...
                        <p>Cutting-edge solutions in software development, data analysis, AI integration, cybersecurity, and cloud computing.</p>
                    </div>

                    <div class="awesome-card two" src="#" data-cue="fadeIn">
                        <!-- <div class="awesome-image">
                        ...
                        <p>Business development, automation, compliance analysis, and business registration services.</p>
                    </div>

                    <div class="awesome-card three" src="#" data-cue="fadeIn">
                        <!-- <div class="awesome-image">
                        ...
                        <p>Training programs, educational workshops, webinars, and mentorship sessions focused on career, finance, and personal development.
                        </p>
                    </div>

                    <div class="awesome-card four" src="#" data-cue="fadeIn">
                        <!-- <div class="awesome-image">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="features-card" data-cues="fadeIn" data-group="images">
                            <!-- <i class="flaticon-diagram"></i> -->
                            <div class="features">
                                <h4>Empathy</h4>
                                <p>At Owujupe, empathy is the cornerstone of our services.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="features-card two" data-cues="fadeIn" data-group="images">
                            ...
                            <div class="features">
                                <h4>Trust</h4>
                                <p>Building strong relationships based on honesty and reliability.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="business-experience">
                ...
                <div class="vbnmr-slider owl-carousel owl-theme owl-loaded owl-drag">
                    <div class="sponsor-logo">
                        <img src="https://ugc.production.linktr.ee/a2f53a9e-f81e-4bcb-9054-dc11b80d9fa3_NMCD-Inc-logo--1-.png?io=true&size=avatar-v3_0" alt="image">
                    </div>
                    <div class="sponsor-logo">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="say-card" data-cues="fadeIn" data-duration="2000">
                            <h4>
        ...
        <div class="blog-area pt-100 pb-70">
            <div class="container" id="blog">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card" src="https://www.georgebrown.ca/event/black-excellence-entrepreneur-panel-discussion-event" data-cue="fadeIn">
                            <div class="single">
                                <div class="blog-img">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card" src="https://www.georgebrown.ca/news/2024/startgbc-celebrates-an-outstanding-month" data-cue="fadeIn">
                            <div class="single">
                                <div class="blog-img">
                                    <a href="https://www.georgebrown.ca/news/2024/startgbc-celebrates-an-outstanding-month">
                                        <img src="https://www.georgebrown.ca/sites/default/files/styles/original_2x_s_max_width_1366px_/public/images/2024-06/startGBC_Collision_RIES_Website.jpg?itok=ycpuPSM2" alt="blog-image">
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card" src="https://africasti.net/africastis-godfrey-jonas-to-feature-in-biggest-tech-event-in-canada/" data-cue="fadeIn">
                            <div class="single">
                                <div class="blog-img">
                                    <a href="https://africasti.net/africastis-godfrey-jonas-to-feature-in-biggest-tech-event-in-canada/">
                                        <img src="https://africasti.net/wp-content/uploads/2024/06/Gofrey-Jonas.jpg" alt="blog-image">
                                    </a>
                                ...
                                <div class="blog-content">
                                    ...
                                    <h4>
                                        <a href="https://africasti.net/africastis-godfrey-jonas-to-feature-in-biggest-tech-event-in-canada/">AfricaSTI’s Godfrey Jonas To Feature In Biggest Tech Event In Canada</a>
                                    </h4>
                                    <p>Tech genius, Godfrey Jonas has been handpicked by the George Brown College, Toronto Ontario to represent the college at one of the biggest tech events in Canada.</p>
                                </div>
                            </div>
                        </div>
                    </div>
